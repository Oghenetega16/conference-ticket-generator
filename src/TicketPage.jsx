    ...
    return (
        <Background>
                ...
                <div className="text-center">
                    <h1 className="text-3xl font-bold mt-8 mb-6">Congrats, <span className="bg-gradient-to-r from-[hsl(7,86%,67%)] to-[hsl(0,0%,100%)] bg-clip-text text-transparent capitalize">{formData.fullName}</span>! Your ticket is ready.</h1>
                    <p className="text-neutral-300">We've emailed your ticket to <span className="text-orange-500">{formData.email}</span> and will send updates in the run up to the event.</p>
                </div>
